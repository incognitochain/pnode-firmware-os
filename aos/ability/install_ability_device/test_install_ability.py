...
class TestCaseInstallAbility(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data = json.loads(json.loads ("{\"source\": \"eac7efdf-00ce-4404-af69-26c9da50cb39\", \"type\": \"install_ability_device\", \"protocol\": \"firebase\", \"data\": \"{\\\"app\\\": \\\"product_control_test\\\", \\\"version\\\": \\\"1.0\\\", \\\"link\\\": \\\"http://s3.amazonaws.com/s3-robotbase/product_control_test.zip\\\", \\\"is_service\\\": 0, \\\"action\\\": \\\"add\\\", \\\"md5_hash\\\": \\\"42e144f5829753ff55d953367297a2d2\\\", \\\"application_file\\\": \\\"main.py\\\"}\", \"time\": \"1489720855370000000\"}")['data'])
        # self.data = json.loads(json.loads ("{\"source\": \"3905853932be45683d4ff6b8a5b1f2c3\", \"type\": \"install_ability_device\", \"protocol\": \"firebase\", \"data\": \"{\\\"app\\\": \\\"personal_assistant\\\", \\\"version\\\": \\\"1.0.5\\\", \\\"link\\\": \\\"http://s3.amazonaws.com/robotbase-cloud/static/upload_apps/personal_assistant_1.4.42_2_320.zip\\\", \\\"is_service\\\": 0, \\\"action\\\": \\\"add\\\", \\\"md5_hash\\\": \\\"3905853932be45683d4ff6b8a5b1f2c3\\\", \\\"application_file\\\": \\\"main.py\\\"}\", \"time\": \"1489720855370000000\"}")['data'])
